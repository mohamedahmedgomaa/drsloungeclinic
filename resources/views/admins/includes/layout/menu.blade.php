            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.dashboard') }}" class="nav-link">
                        ...
                        <p>{{ trans('admins.dashboard') }}</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin.order') }}" class="nav-link">
                        <i class="nav-icon fas fa-book-medical"></i>
                        <p>{{ trans('admins.orders') }}</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin.booking') }}" class="nav-link">
                        <i class="fas fa-book nav-icon"></i>
                        <p>{{ trans('admins.userBookings') }}</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.orderStatus') }}" class="nav-link">
                        <i class="nav-icon fas fa-book-medical"></i>
                        <p>{{ trans('admins.orderStatuses') }}</p>
                    </a>
                </li>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.productCategory') }}" class="nav-link">
                                ...
                                <p>{{ trans('admins.productCategories') }}</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.productSubCategory') }}" class="nav-link">
                                <i class="nav-icon fas fa-tree"></i>
                                <p>{{ trans('admins.productSubCategory') }}</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.productSubSubCategory') }}" class="nav-link">
                                <i class="nav-icon fas fa-tree"></i>
                                <p>{{ trans('admins.subSubCategory') }}</p>
                            </a>
                        </li>
