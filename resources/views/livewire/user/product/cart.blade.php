            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    <div class="card-header py-3">
                        <h5 class="mb-0">Cart - {{ Cart::count() }} Services</h5>
                    </div>
                        ...
                        <!-- Single item -->
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-md-6 mb-4 mb-lg-0">
                                    <!-- Data -->
                                    <p><strong><a href="{!! URL::route('user.product', $product->id) !!}">{!! $product->name !!}</a></strong></p>
                                    <p><strong>{{ $product->price }} SAR</strong></p>
                                    <button type="button" wire:click="remove('{{ $product->rowId }}')" class="btn btn-danger btn-sm me-1 mb-2"
...
{{--                                    </button>--}}
                                ...
                                <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                                    ...
                                    <div class="d-flex mb-4" style="max-width: 300px">
                                        <button class="btn btn-primary px-3 me-2" wire:loading.attr="disabled" wire:click="decrease('{{ $product->rowId }}', {{ $product->qty }})"
                                                onclick="this.parentNode.querySelector('input[type=number]').stepDown()">
                                            <i class="fas fa-minus"></i>
                                        </button>

                                        <div class="form-outline">
                                            <input id="form1" min="0" value="{{ $product->qty }}" type="number" disabled="disabled"
                                                   class="form-control"/>
                                            <label class="form-label" for="form1">Quantity</label>
                                        </div>

                                        <button class="btn btn-primary px-3 ms-2" wire:loading.attr="disabled"  wire:click="increase('{{ $product->rowId }}', {{ $product->qty }})"
            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            {!! Form::submit('submit', ['class' => 'btn btn-primary w-100 mt-3','wire:loading.attr'=>"disabled" ,'wire:target'=>"bookCart"]) !!}
                        </div>
                        {!! Form::close() !!}
