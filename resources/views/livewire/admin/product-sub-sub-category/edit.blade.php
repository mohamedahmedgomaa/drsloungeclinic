        ...
        <div class="modal-content">
            ...
            <form wire:submit.prevent="update" class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="product_sub_category_id" class="label-control">{{__('admins.product_sub_categories')}}</label>
                        {!! Form::select('product_sub_category_id', $product_sub_categories, null, ['class'=>'form-control', 'placeholder'=>trans('admins.product_sub_categories'),'wire:model.lazy'=>'product_sub_category_id']) !!}
