@section('title', trans('admins.tags'))
...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"
                            id="row-separator-colored-controls">{{ trans('admins.tags') }}</h4>
                    ...
                    @include('livewire.admin.tag.create')
            ...
            @include('livewire.admin.tag.edit')

            @include('livewire.admin.tag.delete')
